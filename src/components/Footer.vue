<template>
  <footer class="w-full bg-section">
    <div class="mx-auto px-4 sm:px-6 py-12">
      <div
        class="flex flex-col-reverse gap-10 sm:flex-row sm:items-center sm:justify-between"
      >
        <!-- Left side -->
        ...
        <div class="flex flex-col">
          <p class="text-2xl text-foreground font-semibold">Let's connect!</p>
          <a
            href="https://www.linkedin.com/in/schmidpatrick1337/"
            target="_blank"
          ...
          <!-- <a
            href="https://github.com/schmidpatrick"
            target="_blank"
            rel="noopener noreferrer"
            class="text-muted-foreground hover:text-foreground transition-colors"
          >
